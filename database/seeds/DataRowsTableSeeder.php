                ...
                'details'      => '
{
    ...
    "options": {
        ...
        $dataRow = $this->dataRow($postDataType, 'video');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'file',
                'display_name' => 'Post Video',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($postDataType, 'gallery_img_1');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Post Gallery Image 1',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
                ...
                'details'      => '
{
    ...
    "thumbnails": [
        ...
        $dataRow = $this->dataRow($postDataType, 'gallery_img_2');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Post Gallery Image 2',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
                ...
                'details'      => '
{
    ...
    "thumbnails": [
        ...
        $dataRow = $this->dataRow($postDataType, 'gallery_img_3');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Post Gallery Image 3',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
                ...
                'details'      => '
{
    ...
    "thumbnails": [
        ...
        $dataRow = $this->dataRow($postDataType, 'display_gallery_as_slider');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'checkbox',
                'display_name' => 'Display Gallery as Slider',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($postDataType, 'parent_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postDataType, 'series_intro');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'checkbox',
                'display_name' => 'Series Intro',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($postDataType, 'has_complex_body');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'checkbox',
                'display_name' => 'Has Complex Body',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
